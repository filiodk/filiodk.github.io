...
function initFeatures(settings) {
    ...
    function genLocalForm () {
        var localForms = {
            ...
            'ru' : '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">सफलता से!</span> <s><span class="js_old_price price_old">' + settings.priceMain * 2 + settings.currencyMain + '</span></s><br> <b class="new_price js_new_price price_main">' + settings.priceMain + settings.currencyMain + '</b> </div>' : '') + '</div> <center> <h3 style="text-align: center">अगले पाठक के लिए प्रस्ताव पारित होने तक छूट पर ऑर्डर करने के लिए जल्दी करें! <br> यह ऑफ़र अमान्य हो जाएगा:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="getform.php" method="POST"> <select class="country_select wheel_input" name="country">' + ((!!settings.formApi && settings.formApi.isNeeded) ? formApiCode : '</select>')  + ' <label for="name" class="data_label">आपका नाम:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="पहला नाम "><label for="phone" class="data_label">फ़ोन नंबर:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+91"> <input type="hidden" name="landing" value="' + ((!!settings.formApi && settings.formApi.isNeeded) ? settings.formApi.landingValue : window.location.host) + '"> <button class="main-link" type="submit">आदेश देना ' + settings.product + ' 50% की छूट!</button> </form> </div><center> <h2 class="time_remains_title">तक मान्य करें (सम्मिलित):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
  ...
  var commentsRefreshing = document.querySelector('.comments-refreshing-wrapper');
	...
	var wheelBlocks = {
        ...
        'ru': { 
            wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>सावधानी!</b><br>हमारी साइट पर आने वाले लोगों को ऑर्डर करने का एक विशेष अवसर है ' + settings.product + ' 50% तक की छूट! ऐसा करने के लिए, बटन दबाकर भाग्य का पहिया शुरू करें "SPIN",और फिर इसके पूरी तरह से रुकने का इंतजार करें। कौन जानता है, शायद आप भाग्यशाली हैं जो आज कुछ पैसे बचाने का प्रबंधन करेंगे! सौभाग्य है </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
			popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">बधाई हो!</span> <p class="pop-up-text">आप ऑर्डर कर सकते हैं ' + settings.product + ' 50% की छूट!</p> <a class="pop-up-button" href="#">Ok</a> </div> </div>',
